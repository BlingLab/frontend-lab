...
현재 패키지는 26개 제품 컴포넌트와 5개 레이아웃 primitive를 React + TypeScript 컴포넌트로 제공합니다.
The package currently provides 26 product components and 5 layout primitives as React + TypeScript components.
