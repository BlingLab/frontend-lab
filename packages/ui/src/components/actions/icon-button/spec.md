...
- public component: `IconButton`
- folder slug: `icon-button`
- category: `actions`
...
- 기준 문서 / Reference: [https://www.w3.org/WAI/ARIA/apg/patterns/button/](https://www.w3.org/WAI/ARIA/apg/patterns/button/)
...
- 이 컴포넌트는 `button` primitive를 기준으로 구현합니다. / This component is implemented around the `button` primitive.
