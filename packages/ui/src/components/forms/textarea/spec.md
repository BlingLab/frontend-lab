...
- 기준 문서 / Reference: [https://html.spec.whatwg.org/multipage/form-elements.html#the-textarea-element](https://html.spec.whatwg.org/multipage/form-elements.html#the-textarea-element)
...
- 이 컴포넌트는 `textarea` primitive를 기준으로 구현합니다. / This component is implemented around the `textarea` primitive.
