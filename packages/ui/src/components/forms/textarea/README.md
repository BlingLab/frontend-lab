...
- 기본 primitive / Base primitive: `textarea`
- 참고 pattern / Reference pattern: https://html.spec.whatwg.org/multipage/form-elements.html#the-textarea-element
