...
form submission이 아니라 즉시 적용되는 설정에 사용합니다.
Use for settings that take effect immediately rather than form submission choices.

## 요약 / Summary

즉시 반영되는 on/off setting control입니다.
...
- 기본 primitive / Base primitive: `button or input checkbox with switch semantics`
- 참고 pattern / Reference pattern: https://www.w3.org/WAI/ARIA/apg/patterns/switch/
