...
- primitive / Primitive: `button or input checkbox with switch semantics`
- 참고 pattern / Pattern reference: https://www.w3.org/WAI/ARIA/apg/patterns/switch/
