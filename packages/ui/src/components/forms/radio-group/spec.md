...
- public component: `RadioGroup`
- folder slug: `radio-group`
- category: `forms`
...
- 기준 문서 / Reference: [https://www.w3.org/WAI/ARIA/apg/patterns/radio/](https://www.w3.org/WAI/ARIA/apg/patterns/radio/)
...
- 이 컴포넌트는 `fieldset with input[type='radio']` primitive를 기준으로 구현합니다. / This component is implemented around the `fieldset with input[type='radio']` primitive.
