...
- 기본 primitive / Base primitive: `input[type='checkbox']`
- 참고 pattern / Reference pattern: https://www.w3.org/WAI/ARIA/apg/patterns/checkbox/
