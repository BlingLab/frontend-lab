...
폼 copy, validation feedback, accessible relationship을 표준화할 때 사용합니다.
Use to normalize form copy, validation feedback, and accessible relationships.

## 요약 / Summary

form control의 label, description, error, required marker를 공유하는 wrapper입니다.
...
- 기본 primitive / Base primitive: `label and form control relationship`
- 참고 pattern / Reference pattern: https://www.w3.org/WAI/ARIA/apg/practices/names-and-descriptions/
