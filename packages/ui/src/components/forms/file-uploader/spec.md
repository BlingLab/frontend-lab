# FileUploader 스펙 / FileUploader Spec
...
- primitive / Primitive: `input[type='file']`
- 참고 pattern / Pattern reference: https://html.spec.whatwg.org/multipage/input.html#file-upload-state-(type=file)
