...
- primitive / Primitive: `select or combobox/listbox pattern`
- 참고 pattern / Pattern reference: https://www.w3.org/WAI/ARIA/apg/patterns/combobox/
