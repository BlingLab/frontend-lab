...
- primitive / Primitive: `input[type='date']`
- 참고 pattern / Pattern reference: https://html.spec.whatwg.org/multipage/input.html#date-state-(type=date)
