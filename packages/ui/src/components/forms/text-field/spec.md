...
- 기준 문서 / Reference: [https://html.spec.whatwg.org/multipage/input.html](https://html.spec.whatwg.org/multipage/input.html)
...
- 이 컴포넌트는 `input` primitive를 기준으로 구현합니다. / This component is implemented around the `input` primitive.
