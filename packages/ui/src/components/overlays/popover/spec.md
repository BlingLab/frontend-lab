...
- 이 컴포넌트는 `button plus positioned region` primitive를 기준으로 구현합니다. / This component is implemented around the `button plus positioned region` primitive.
