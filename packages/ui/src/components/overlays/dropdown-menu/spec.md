# DropdownMenu 명세 / DropdownMenu Spec
...
- public component: `DropdownMenu`
- folder slug: `dropdown-menu`
- category: `overlays`
...
- 기준 문서 / Reference: [https://www.w3.org/WAI/ARIA/apg/patterns/menu-button/](https://www.w3.org/WAI/ARIA/apg/patterns/menu-button/)
...
- 이 컴포넌트는 `menu button pattern` primitive를 기준으로 구현합니다. / This component is implemented around the `menu button pattern` primitive.
