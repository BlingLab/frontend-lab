# DropdownMenu 스펙 / DropdownMenu Spec
...
- primitive / Primitive: `menu button pattern`
- 참고 pattern / Pattern reference: https://www.w3.org/WAI/ARIA/apg/patterns/menu-button/
