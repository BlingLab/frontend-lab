# CommandPalette 스펙 / CommandPalette Spec
...
- primitive / Primitive: `dialog with combobox-style command list`
- 참고 pattern / Pattern reference: https://www.w3.org/WAI/ARIA/apg/patterns/dialog-modal/
