# CommandPalette 컴포넌트 / CommandPalette
...
Use for global command discovery, quick navigation, and shortcut-driven actions.

## 요약 / Summary

컴포넌트의 역할과 사용 맥락을 요약합니다.
Keyboard-friendly command search surface.
...
- 기본 primitive / Base primitive: `dialog with combobox-style command list`
