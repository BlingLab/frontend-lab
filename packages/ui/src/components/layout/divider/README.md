# Divider 컴포넌트 / Divider

> 상태 / Status: `ready` | 우선순위 / Priority: `P1` | 카테고리 / Category: 레이아웃 / Layout

## 목적 / Purpose

새 container를 만들지 않고 인접 section을 구분할 때 사용합니다.
Use to separate adjacent sections without introducing a new container.

## 요약 / Summary

관련 group 사이의 visual separator입니다.
...
- 기본 primitive / Base primitive: `hr or role='separator'`
