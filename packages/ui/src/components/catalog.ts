...
export const componentCatalog: ComponentCatalogItem[] = [
  ...
  },
  {
    ...
    priority: "P0",
    status: "ready",
    summary: "Responsive page-width wrapper for product layouts.",
    purpose: "Use to constrain page content to a predictable readable width while keeping safe gutters.",
    primitive: "div",
    apg: "",
    props: ["size"],
  ...
  },
  {
    ...
    priority: "P0",
    status: "ready",
    summary: "Horizontal flex layout primitive with shared gap, alignment, and justification axes.",
    purpose: "Use to arrange related children in a wrapping horizontal flow.",
    primitive: "div",
    apg: "",
  ...
  },
  {
    ...
    priority: "P0",
    status: "ready",
    summary: "Responsive 12-column child primitive for Row layouts.",
    purpose: "Use inside Row to define responsive column spans across viewport breakpoints.",
    primitive: "div",
    apg: "",
    props: ["span", "sm", "md", "lg"],
  ...
  },
  {
    ...
    priority: "P0",
    status: "ready",
    summary: "Vertical layout primitive with shared gap and alignment axes.",
    purpose: "Use to stack form fields, actions, and repeated blocks with predictable spacing.",
    primitive: "div",
    apg: "",
    props: ["gap", "align"],
  ...
  },
  {
    ...
    priority: "P0",
    status: "ready",
    summary: "Inline wrapping layout primitive for compact groups.",
    purpose: "Use to align badges, actions, filters, or short metadata in a wrapping inline flow.",
    primitive: "div",
    apg: "",
    props: ["gap", "align", "justify"],
    states: ["gap-sm", "gap-md", "gap-lg", "aligned", "justified"],
