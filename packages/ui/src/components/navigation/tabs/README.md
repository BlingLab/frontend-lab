...
> 상태 / Status: `ready` | 우선순위 / Priority: `P0` | 카테고리 / Category: 내비게이션 / Navigation

## 목적 / Purpose

같은 page location을 공유하는 peer section을 full navigation 없이 전환할 때 사용합니다.
Use for peer sections that share a page location and do not require full navigation.

## 요약 / Summary

같은 context 안에서 관련 panel을 전환합니다.
...
- 기본 primitive / Base primitive: `tabs pattern`
- 참고 pattern / Reference pattern: https://www.w3.org/WAI/ARIA/apg/patterns/tabs/
