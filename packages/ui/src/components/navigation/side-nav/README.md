...
Use for application sidebars with grouped destinations and persistent current state.

## 요약 / Summary

컴포넌트의 역할과 사용 맥락을 요약합니다.
Sectioned vertical navigation for product workspaces.
...
- 기본 primitive / Base primitive: `nav with grouped lists`
