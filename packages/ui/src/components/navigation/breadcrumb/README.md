...
- 기본 primitive / Base primitive: `nav with ordered list`
- 참고 pattern / Reference pattern: https://www.w3.org/WAI/ARIA/apg/patterns/breadcrumb/
