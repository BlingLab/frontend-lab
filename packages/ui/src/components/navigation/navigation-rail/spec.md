# NavigationRail 명세 / NavigationRail Spec
...
- public component: `NavigationRail`
- folder slug: `navigation-rail`
- category: `navigation`
...
- 이 컴포넌트는 `nav with list of links or buttons` primitive를 기준으로 구현합니다. / This component is implemented around the `nav with list of links or buttons` primitive.
