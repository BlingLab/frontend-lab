# NavigationRail 컴포넌트 / NavigationRail
...
Use when top-level destinations need persistent icon-first navigation in wide layouts.

## 요약 / Summary

컴포넌트의 역할과 사용 맥락을 요약합니다.
Compact vertical primary navigation for app shells.
...
- 기본 primitive / Base primitive: `nav with list of links or buttons`
