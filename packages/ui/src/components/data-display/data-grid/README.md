# DataGrid 컴포넌트 / DataGrid

> 상태 / Status: `ready` | 우선순위 / Priority: `P0` | 카테고리 / Category: 데이터 표시 / Data Display

## 목적 / Purpose

이 컴포넌트가 해결하는 UI 문제를 설명합니다.
Use when dense records need structured scanning with richer controls than a static table.

## 요약 / Summary

컴포넌트의 역할과 사용 맥락을 요약합니다.
Interactive tabular grid with sorting, selection, and row actions.
...
- 기본 primitive / Base primitive: `table with grid-like interactions`
- 참고 pattern / Reference pattern: https://www.w3.org/WAI/ARIA/apg/patterns/grid/
